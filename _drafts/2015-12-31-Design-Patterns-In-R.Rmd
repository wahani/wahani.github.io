...
logger to a function or taking care that a function preserves attributes, which
...
function which has an environment associated to it. E.g. a function
...
one of Hadley's examples to get the idea. 
